...
export default async function Home() {
  return (
    <div className="min-h-full w-full flex flex-col items-center justify-center p-4 overflow-y-auto">
      <Card className="max-w-4xl w-full text-center px-6 py-12 border-0 backdrop-blur-sm flex flex-col">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-normal bg-clip-text ">
          Wish it, Think it, Note it.
        </h1>
        <h2
          className="mt-6 text-xl md:text-2xl lg:text-3xl font-semibold
        tracking-normal text-gray-500 max-w-3xl w-full self-center text-center"
        >
